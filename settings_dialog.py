...
# Form implementation generated from reading ui file '/home/jakubfidler/Documents/programming/anki_addons/Custom-background-image-and-gear-icon/settings_dialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBox_defaultfiles = QtWidgets.QCheckBox(self.groupBox_2)
        self.checkBox_defaultfiles.setToolTipDuration(10000)
        self.checkBox_defaultfiles.setChecked(True)
        self.checkBox_defaultfiles.setObjectName("checkBox_defaultfiles")
        self.gridLayout_4.addWidget(self.checkBox_defaultfiles, 3, 0, 1, 1)
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("/home/jakubfidler/Documents/programming/anki_addons/Custom-background-image-and-gear-icon/CustomBackground:AnkiPalace_no_text.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("/home/jakubfidler/Documents/programming/anki_addons/Custom-background-image-and-gear-icon/CustomBackground:AnKingSmall.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("/home/jakubfidler/Documents/programming/anki_addons/Custom-background-image-and-gear-icon/CustomBackground:YouTube.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("/home/jakubfidler/Documents/programming/anki_addons/Custom-background-image-and-gear-icon/CustomBackground:Patreon.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("/home/jakubfidler/Documents/programming/anki_addons/Custom-background-image-and-gear-icon/CustomBackground:Instagram.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("/home/jakubfidler/Documents/programming/anki_addons/Custom-background-image-and-gear-icon/CustomBackground:Facebook.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBox_defaultfiles.setToolTip(_translate("Dialog", "<html><head/><body><p>Choose whether you want defualt photos in the random images. If checked, default files will be used, if unchecked, default files will not be used and only your custom files will be included.<br/></p></body></html>"))
        self.checkBox_defaultfiles.setText(_translate("Dialog", "Use Default Background"))
